...
print('=' * 60)
print('📊 반디 퀀트 - SK하이닉스 (000660.KS) 단독 분석')
print('=' * 60)
print(f'⏰ {datetime.now().strftime("%Y-%m-%d %H:%M")} KST')
print()

# 데이터 수집
df = yf.download('000660.KS', period='6mo', progress=False)
...
if CHART_AVAILABLE:
    ...
    chart_path = f"{CHART_DIR}/SK하이닉스_단독분석_{date_str}.png"
